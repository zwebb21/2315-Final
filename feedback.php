...
if (($email_is_required && (empty($email) || (substr_count($email,'@') != 1))) || (strlen($email) > 254) || preg_match("/[\s<>,;'\"]/", $email) ||
	($name_is_required && empty($firstname)) || (strlen($firstname) > 729) || preg_match("/[\r\n@<>,;\"]/", $firstname) ||
...
$messageproper =
	...
	"------------------------------------------------------------" . $linesep .
	"FirstName of sender: $firstname" . $linesep .
		"Last Name of sender: $lastname" . $linesep .
		"The City of sender: $city" . $linesep .
...
$headers =
	"From: \"$firstname\" <$fromemail>" . $linesep . "Reply-To: \"$firstname\" <$email>" . $linesep . "X-Mailer: chfeedback.php 3.1.0" .
